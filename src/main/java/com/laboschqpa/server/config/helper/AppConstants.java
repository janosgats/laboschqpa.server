...
public class AppConstants {
    ...
    //language=RegExp
    public static final String generalNameValidatorPattern = "^[a-zA-Z0-9!_'áéíóöőúüűÁÉÍÓÖŐÚÜŰ ~().#Ł$§+-]*$";
    //language=RegExp
    public static final String nickNameValidatorPattern = "^[a-zA-Z0-9!_(),':%áéíóöőúüűÁÉÍÓÖŐÚÜŰ Ł$§+-]*$";
